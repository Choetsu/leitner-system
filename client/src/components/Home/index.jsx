    ...
    return (
      <div className="flex flex-col items-center justify-center mt-24 pt-16">
        ...
        <p className="text-lg text-gray-700 mb-8 text-center">
          Une application pour vous aider à organiser et à réviser vos fiches de
          révision de manière efficace.
        </p>
        <button
              ...
              {quizz.map((item) => (
                <div key={item.id} className="mb-6">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleUserResponseChange(item.id, e.target.value)
                    }
                    className="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                  ...
                  <button
                    onClick={() =>
                      validateAnswer(item.id, userResponses[item.id])
                    }
